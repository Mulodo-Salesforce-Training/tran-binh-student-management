...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        ...
        <field>Student_Scoring_Skill__c.Active__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Student_Scoring_Skill__c.Points__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Student_Scoring_Skill__c.Skill__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Student_Scoring_Skills__c.Points__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Student__c.Level__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Student__c.Skills__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Student__c.State_Province__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Student__c.Street__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <recordTypeVisibilities>
        ...
        <recordType>Student_Scoring_Skill__c.Java</recordType>
        <visible>true</visible>
    </recordTypeVisibilities>
    <recordTypeVisibilities>
        <default>false</default>
        <recordType>Student_Scoring_Skill__c.PHP</recordType>
        <visible>true</visible>
    </recordTypeVisibilities>
    <recordTypeVisibilities>
        <default>false</default>
        <recordType>Student_Scoring_Skill__c.Salesforce</recordType>
        <visible>true</visible>
    </recordTypeVisibilities>
    <recordTypeVisibilities>
        <default>false</default>
        <recordType>Student_Scoring_Skills__c.Database_Network</recordType>
        <visible>false</visible>
    </recordTypeVisibilities>
    <recordTypeVisibilities>
        <default>true</default>
        <personAccountDefault>true</personAccountDefault>
        <recordType>Student_Scoring_Skills__c.Web_Aplication</recordType>
        <visible>true</visible>
    </recordTypeVisibilities>
    <tabVisibilities>
    ...
    <tabVisibilities>
        <tab>Student_Scoring_Skills__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>Upload_file</tab>
